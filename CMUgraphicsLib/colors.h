...
const color LAVENDER = color(199, 191, 230);
...
const color BLACK = color(10, 10, 10);
...
const color SKYBLUE = color(182, 211, 219);
...
const color GREEN = color(3, 97, 44);
const color GREEN2 = color(84, 128, 93);
...
const color LIGHTYELLOW = color(239, 227, 175);
...
const color ROSYBROWN = color(185, 122, 87);
...
const color DARKRED = color(136, 0, 22);
...
const color PURPLE = color(163, 73, 163);
const color MEDIUMPURPLE = color(128, 82, 108);
...
const color LIGHTGREEN = color(219, 227, 212);
