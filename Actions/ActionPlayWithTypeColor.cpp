#include "ActionPlayWithTypeColor.h"
#include "../ApplicationManager.h"
#include "../GUI/GUI.h"
ActionPlayWithTypeColor::ActionPlayWithTypeColor(ApplicationManager* pApp) :Action(pApp)
{
	correct = 0;
	wrong = 0;
}
void ActionPlayWithTypeColor::Execute() {
	...
	if (Fig != "Empty") {
		stringstream print;
		print << pManager->Color2String(Fig_Type_color);
